...
import { Colors, Fonts, Gaps } from '../../../../shared';
	...
	return (
		...
		>
			<View
				style={{
					...styles.menu,
					borderRightColor: isActive ? Colors.primary : Colors.black,
					backgroundColor: clicked || isActive ? Colors.violet_dark : Colors.black,
				}}
			>
				{icon}
